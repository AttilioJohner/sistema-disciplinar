...
class LocalDatabase {
  constructor() {
    ...
    this.baseUrl = window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1' 
      ? '../data/db.json' 
      : 'https://raw.githubusercontent.com/AttilioJohner/sistema-disciplinar-revisado/master/data/db.json';
  }
...
// Compatibilidade com código existente do Firebase
window.db = {
...
window.isFirebaseReady = () => localDb.loaded;
